  ...
  return (
    <section className="py-16 bg-white">
      <div className="container px-4 mx-auto text-center">
        <h2 className="text-3xl font-bold text-[#0a3b25] uppercase">Ivy Coach's College Admissions Track Record</h2>
        ...
        <div className="grid grid-cols-2 gap-8 mt-12 md:grid-cols-4">
          <div className="p-6 text-center">
            <div className="text-5xl font-bold text-[#0a3b25]">
        ...
        <div className="grid grid-cols-1 gap-8 mt-12 md:grid-cols-2">
          <div className="p-6 border rounded-lg">
            <div className="flex flex-col items-center">
              <div className="text-4xl font-bold text-[#0a3b25]">
